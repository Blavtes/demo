...
- (id)init
{
    ...
    if (self) {
        ...
        UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(260, 0, 50, 44)];
        [btn setTitle:@"取消" forState:UIControlStateNormal];
        [btn addTarget:self action:@selector(removeSuperviewFrowWindow) forControlEvents:UIControlEventTouchUpInside];

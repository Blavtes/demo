...
@property (nonatomic, retain)UIView                     *viewMidBase;
@property (nonatomic, retain)UIView                     *viewUpBase;
@property (nonatomic, retain)UIView                     *viewDownBase;
@property (nonatomic, retain)WordsLeftView              *viewWordNum;
...
@property (nonatomic, retain)AttachedPictureView        *viewImage; 
@property (nonatomic, retain)AttachedPictureCtrlView    *ctrlimageView;

...
- (void)request:(TCWBRequest *)req didFinishLoadingWithResult:(id)result{
    ...
    if (((NSDictionary*)[result objectForKey:@"data"]).count == 2 && ((NSDictionary*)result).count == 6) {
        UIAlertView* alertView = [[UIAlertView alloc]initWithTitle:nil
                                                           message:@"操作成功"
                                                          delegate:self
                                                 cancelButtonTitle:@"确定"
...
- (void)request:(TCWBRequest *)req didFailWithError:(NSError *)error{
    if (error) {
        NSLog(@"requestdidFailWithErrorerror..%@",error);
    }
...
//        [dic setObject:@"11.23232" forKey:@"jing"];
//        [dic setObject:@"33.32332" forKey:@"wei"];
        if (content) {
            [dic setObject:content forKey:@"content"];
        }
        if (image) {
...
{
    NSLog(@"onSuccessCallback");
}
- (void)onFailureCallback
{
    NSLog(@"onFailureCallback");
}
- (void)UIBroadCastMsgWithContent:(NSString *)content
